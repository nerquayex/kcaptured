...
export function Footer() {
  ...
  // Fallback values
  const FALLBACK_EMAIL = "kenny.stevens13@hotmail.com";
  const FALLBACK_INSTAGRAM = "https://www.instagram.com/kcaptures_.1";
  const FALLBACK_TIKTOK = "https://www.tiktok.com/@kcaptured_";
  ...
  useEffect(() => {
    ...
    fetch("/api/settings")
      ...
      .catch(() => console.warn("Failed to load settings"));
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-500 text-sm">
                  Professional photography specializing in lifestyle and studio
                  portraits.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                <a
                  href={`mailto:${settings.email ?? FALLBACK_EMAIL}`}
                ...
                <div className="flex gap-3">
                  <a
                    href={settings.instagram_url ?? FALLBACK_INSTAGRAM}
                    target="_blank"
                  ...
                  <a
                    href={settings.tiktok_url ?? FALLBACK_TIKTOK}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:opacity-75 transition-opacity"
